...
export default function DeleteAssesmentModal({ onClose, onDelete }) {
  return (
  <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex justify-center items-center">
      <div className="relative p-4 w-full max-w-sm md:max-w-lg lg:max-w-2xl">
        <div className="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
          ...
          <p className="mb-4 text-gray-500">Are you sure you want to delete this Assesment?</p>
